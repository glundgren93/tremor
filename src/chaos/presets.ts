import type { ChaosPreset } from "../types/chaos";
...
export const PRESETS: ChaosPreset[] = [
  ...
  },
  {
    ...
    name: "Slow Network",
    description:
      "~1.5s latency on all requests (normal distribution, models network-level degradation)",
    rules: [
      {
  ...
  },
  {
    ...
    name: "Empty Response",
    description:
      "API requests return 200 OK with empty JSON body (tests response shape validation)",
    rules: [
      {
